...
$paths = @(
  ...
  "src/content.js",
  "photos.html",
  "assets/photos/originals/010.jpg",
  "assets/photos/thumbs/010.webp",
  "assets/pdf/technical-requirements.pdf",
  "assets/pdf/hospitality-rider.pdf",
  "assets/pdf/promoter-guide.pdf",
  "assets/images/va-logo-white.png",
  "assets/images/va-logo-black.png",
